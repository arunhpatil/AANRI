#!/bin/bash
#SBATCH --job-name=hippo_Oligodendrocyte_smr
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=/dcs04/lieber/hwanglab/Arun/snRNA_aanri/1_source/batch_executables/5_SMR_associations/hippo/logs/Oligodendrocyte_%j.out 
#SBATCH --error=/dcs04/lieber/hwanglab/Arun/snRNA_aanri/1_source/batch_executables/5_SMR_associations/hippo/logs/Oligodendrocyte_%j.err
