#!/bin/bash
#SBATCH --job-name=hippo_Microglia_twasSummary
#SBATCH --output=/dcs04/lieber/hwanglab/Arun/snRNA_aanri/1_source/batch_executables/4_twas_summarize/hippo/logs/Microglia_%j.out
#SBATCH --error=/dcs04/lieber/hwanglab/Arun/snRNA_aanri/1_source/batch_executables/4_twas_summarize/hippo/logs/Microglia_%j.err
