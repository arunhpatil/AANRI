...
#SBATCH --array=100-1389%100 # IMPORTANT DON'T FORGET TO CHANGE
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=2
#SBATCH --mem=5G
#SBATCH --time=36:00:00
#SBATCH --output=logs/dlpfc_opc_res_fusionWTS_%A_%a.out
#SBATCH --error=logs/dlpfc_opc_res_fusionWTS_%A_%a.err
