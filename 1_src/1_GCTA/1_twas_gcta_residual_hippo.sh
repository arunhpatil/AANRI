#!/bin/bash
#SBATCH --job-name=hippo_CellTypeGCTA_residuals
#SBATCH --cpus-per-task=2
#SBATCH --time=24:00:00
#SBATCH --output=logs/all_regXct_twas_gcta_residuals_hippo2.out
#SBATCH --error=logs/all_regXct_twas_gcta_residuals_hippo2.err
#SBATCH --mem=20G
...
brainRegions=("hippo")
celltypes=("Inhibitory_neuron" "Microglia" "OPC" "Oligodendrocyte") 
