#!/bin/bash
#SBATCH --job-name=caudate_Astrocyte_twasSummary
#SBATCH --output=/dcs04/lieber/hwanglab/Arun/snRNA_aanri/1_source/batch_executables/4_twas_summarize/caudate/logs/Astrocyte_%j.out
#SBATCH --error=/dcs04/lieber/hwanglab/Arun/snRNA_aanri/1_source/batch_executables/4_twas_summarize/caudate/logs/Astrocyte_%j.err
