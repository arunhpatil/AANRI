#!/bin/bash
#SBATCH --job-name=DLPFC_Inhibitory_neuron_twasSummary
#SBATCH --output=/dcs04/lieber/hwanglab/Arun/snRNA_aanri/1_source/batch_executables/4_twas_summarize/DLPFC/logs/Inhibitory_neuron_%j.out
#SBATCH --error=/dcs04/lieber/hwanglab/Arun/snRNA_aanri/1_source/batch_executables/4_twas_summarize/DLPFC/logs/Inhibitory_neuron_%j.err
