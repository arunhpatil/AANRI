#!/bin/bash
#SBATCH --job-name=Excitatory_neuron_nonChr
#SBATCH --output=/dcs04/lieber/hwanglab/Arun/snRNA_aanri/1_source/batch_executables/3_TWAS_associations/DLPFC/chromosome_lvl/Excitatory_neuron/logs/nonChr_%j.out
#SBATCH --error=/dcs04/lieber/hwanglab/Arun/snRNA_aanri/1_source/batch_executables/3_TWAS_associations/DLPFC/chromosome_lvl/Excitatory_neuron/logs/nonChr_%j.err
