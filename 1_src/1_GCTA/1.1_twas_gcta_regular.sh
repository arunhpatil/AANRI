#!/bin/bash
#SBATCH --job-name=allRegionCellTypeGCTA_hippo
#SBATCH --cpus-per-task=2
#SBATCH --time=24:00:00
#SBATCH --output=logs/hippo_all_regXct_twas_gcta_%A.out
#SBATCH --error=logs/hippo_all_regXct_twas_gcta_%A.err
#SBATCH --mem=120G
...
#celltypes=("Excitatory_neuron" "Inhibitory_neuron") 
...
for region in "${brainRegions[@]}"; do
	...
	echo "======================================================"
        ...
        exprn="/dcs04/lieber/hwanglab/Arun/snRNA_aanri/3_analysis/${region}/${celltype}/regular/TWAS/expression/${region}_${celltype}_expression.bed"

        output="/dcs04/lieber/hwanglab/Arun/snRNA_aanri/3_analysis/${region}/${celltype}/regular/TWAS"

        covariates="/dcs04/lieber/hwanglab/Arun/snRNA_aanri/3_analysis/${region}/${celltype}/regular/TWAS/covariates/${region}_${celltype}_covariates.txt"
