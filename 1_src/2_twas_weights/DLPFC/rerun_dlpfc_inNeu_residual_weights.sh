...
#SBATCH --array=927,947,1072,1103,1232,1234,1252,1393,1423,1425,1437,2236,2250%13
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=2
#SBATCH --mem=5G
#SBATCH --time=36:00:00
#SBATCH --output=rerun_logs/dlpfc_inNeu_res_fusionWTS_%A_%a.out
#SBATCH --error=rerun_logs/dlpfc_inNeu_res_fusionWTS_%A_%a.err
