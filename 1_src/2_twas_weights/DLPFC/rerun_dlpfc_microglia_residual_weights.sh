...
#SBATCH --array=325,417,450,473,474,476,486,491,609,780,835,851,863,868,877,878,927,930,939,949,951,952,956,961%24
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=2
#SBATCH --mem=5G
#SBATCH --time=36:00:00
#SBATCH --output=rerun_logs/dlpfc_microglia_res_fusionWTS_%A_%a.out
#SBATCH --error=rerun_logs/dlpfc_microglia_res_fusionWTS_%A_%a.err
