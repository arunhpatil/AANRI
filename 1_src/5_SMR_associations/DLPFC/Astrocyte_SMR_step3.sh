#!/bin/bash
#SBATCH --job-name=DLPFC_Astrocyte_smrSummary
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=/dcs04/lieber/hwanglab/Arun/snRNA_aanri/1_source/batch_executables/5_SMR_associations/DLPFC/logs/Astrocyte_smrSummaize_%j.out
#SBATCH --error=/dcs04/lieber/hwanglab/Arun/snRNA_aanri/1_source/batch_executables/5_SMR_associations/DLPFC/logs/Astrocyte_smrSummarize_%j.err
