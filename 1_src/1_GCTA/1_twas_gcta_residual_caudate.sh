#!/bin/bash
#SBATCH --job-name=caudate_CellTypeGCTA_residuals
#SBATCH --cpus-per-task=2
#SBATCH --time=24:00:00
#SBATCH --output=logs/all_regXct_twas_gcta_residuals_caudate2.out
#SBATCH --error=logs/all_regXct_twas_gcta_residuals_caudate2.err
#SBATCH --mem=20G
...
brainRegions=("caudate")
celltypes=("Microglia" "OPC" "Oligodendrocyte") 
