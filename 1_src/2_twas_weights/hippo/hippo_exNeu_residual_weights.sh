...
#SBATCH --array=1665-1713%100 # IMPORTANT DON'T FORGET TO CHANGE
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=2
#SBATCH --mem=5G
#SBATCH --time=36:00:00
#SBATCH --output=logs/hippo_exNeu_res_fusionWTS_%A_%a.out
#SBATCH --error=logs/hippo_exNeu_res_fusionWTS_%A_%a.err
#SBATCH --exclude=compute-127,compute-145,compute-175,compute-158,compute-099,compute-142,compute-148,compute-144
...
# original SBATCH --array=0-1713%100 # IMPORTANT DON'T FORGET TO CHANGE
