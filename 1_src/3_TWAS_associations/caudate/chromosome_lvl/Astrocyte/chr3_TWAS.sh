#!/bin/bash
#SBATCH --job-name=Astrocyte_chr3
#SBATCH --array=0-64 # %32 # 100 GWAS files (Index 0-99), max 20 running at once
#SBATCH --output=/dcs04/lieber/hwanglab/Arun/snRNA_aanri/1_source/batch_executables/3_TWAS_associations/caudate/chromosome_lvl/Astrocyte/logs/chr3_%A_%a.out
#SBATCH --error=/dcs04/lieber/hwanglab/Arun/snRNA_aanri/1_source/batch_executables/3_TWAS_associations/caudate/chromosome_lvl/Astrocyte/logs/chr3_%A_%a.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --mem=40G
